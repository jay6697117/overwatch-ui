<template>
  <div v-show="!(hideOnSinglePage && total <= 1)" class="ow-pager">
    <span class="ow-pager-item" :class="{ disabled: current === 1 }" @click="onClickPage(current - 1)">
    ...
    <span class="ow-pager-item" :class="{ disabled: current === total }" @click="onClickPage(current + 1)">
