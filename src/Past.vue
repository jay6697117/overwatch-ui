<template>
  <div class="past">
    ...
    <div class="item">
      <ow-cascader :source.sync="source" :selected.sync="cascaderSelected" placeholder="Click to Select"></ow-cascader>
    </div>
    ...
    <div class="item">
      ...
      <ow-modal :is-open.sync="isOpen">
        <template slot="header">ADD A NEW FRIEND</template>
      ...
      source: [
        {
          name: 'CA',
          children: [
            { name: 'Irvine', isLeaf: false, children: [{ name: 'UCI' }, { name: 'UCSB' }, { name: 'UCB' }] },
            { name: 'LA', isLeaf: false, children: [{ name: 'UCLA' }, { name: 'UCB' }, { name: 'UCSD' }] }
          ]
        },
        {
          name: 'NY',
          children: [
            ...
            { name: 'NY', isLeaf: false, children: [{ name: 'NYU' }, { name: 'FU' }, { name: 'BC' }] }
          ]
        }
      ],
      cascaderSelected: [],
