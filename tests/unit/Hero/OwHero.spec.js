...
describe('OwHero.vue', () => {
  ...
  it('receives hero props', () => {
    ...
    expect(OwHeroWrapper.find('.ow-hero-avatar').attributes().style).to.equal(
      'background-image: url(https://d1u1mce87gyfbn.cloudfront.net/hero/hanzo/icon-portrait.png);'
    );
  });
